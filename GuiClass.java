...
public class GuiClass extends JFrame{
	...
	Object[] columns = {"Username", "Password", "Income", "Date Joined"};
...
//	String password;
	...
	public GuiClass(String lookAndFeel) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
	    ...
	    login.setButton(createButton("1"), 50 , 460, 200, 50);
	    login.setButton(budgetGuide, 50, 360, 200, 50);
	    ...
	    example.setButton(createButton("3"));
	    ...
	    budgetGuide.addActionListener(new ActionListener(){
	        ...
	        public void actionPerformed(ActionEvent arg0){
	        	System.out.println("in budget guide");
  			  	JOptionPane.showMessageDialog(new JFrame(),userObj.getBudget(budget));
